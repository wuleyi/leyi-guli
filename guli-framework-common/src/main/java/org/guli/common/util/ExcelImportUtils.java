...
public class ExcelImportUtils {
    ...
    public ExcelImportUtils(InputStream is) throws IOException {
        this(is, 0, true);
    }

    public ExcelImportUtils(InputStream is, int sheetIndex) throws IOException {
        this(is, sheetIndex, true);
    }

    public ExcelImportUtils(InputStream is, int sheetIndex, boolean evaluateFormular) throws IOException {
        super();
